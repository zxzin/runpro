...
The user-facing confirmation message at this pause should match the user's working language by default. If the working language is unclear, use concise English.

This confirmation message should concisely include:

- the project goal as currently understood
- the final deliverable
- the locked core requirements
- the planned execution path
- the questions that still need confirmation or correction
- a direct confirmation request such as `Please confirm whether this scope and plan are correct to begin execution. If anything is off, point to the exact change needed.`
...
Do not force a language switch at this pause unless the user explicitly asks for it.
